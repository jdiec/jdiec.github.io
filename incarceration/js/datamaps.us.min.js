! function() {
    function a(a, b, c) {
        return this.svg = l.select(a).append("svg").attr("width", c || a.offsetWidth).attr("class", "datamap").attr("height", b || a.offsetHeight), this.svg
    }
    ...
    }, k.prototype.worldTopo = "__WORLD__", k.prototype.usaTopo = {
        type: "Topology",
        transform: {
